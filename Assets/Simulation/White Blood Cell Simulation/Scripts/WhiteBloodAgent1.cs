...
public class WhiteBloodAgent1 : Agent
{
        ...
        if (m_Shoot)
        {
            ...
            if (Physics.SphereCast(myTransform.position, 1f, rayDir, out hit, 2f))
            {
                ...
                if (hit.collider.gameObject.CompareTag("agent"))
                {
                    ...
                    hit.collider.gameObject.GetComponent<WhiteBloodAgent1>().Freeze();
                    AddReward(-2);//new
    ...
    public override void AgentReset()
    {
        ...
        GameObject.Find("FoodCollectorSettings").GetComponent<FoodCollectorSettings>().ResetRequest();
